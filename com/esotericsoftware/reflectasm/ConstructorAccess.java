...
public abstract class ConstructorAccess<T> {
   ...
   public static <T> ConstructorAccess<T> get(Class<T> type) {
         ...
         if (accessClass == null) {
            ...
            if (!isNonStaticMemberClass) {
               ...
               try {
                  ...
                  throw new RuntimeException("Class cannot be created (missing no-arg constructor): " + type.getName(), var18);
               }
               ...
               try {
                  ...
                  throw new RuntimeException("Non-static member class cannot be created (missing enclosing class constructor): " + type.getName(), var17);
               }
      ...
      try {
         ...
         throw new RuntimeException("Exception constructing constructor access class: " + accessClassName, var16);
      }
